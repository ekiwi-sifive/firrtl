...
class IntervalSpec extends FirrtlFlatSpec {
  ...
  "Interval types" should "infer bp correctly" in {
    val passes = Seq(ToWorkingIR, InferTypesFlowsAndKinds, new InferBinaryPoints())
    val input =
      """circuit Unit :
        |  module Unit :
        |    input in0 : Interval(-0.32, 10.1).4
  ...
  "Interval types" should "trim known intervals correctly" in {
    val passes = Seq(ToWorkingIR, InferTypesFlowsAndKinds, new InferBinaryPoints(), new TrimIntervals())
    val input =
      """circuit Unit :
        |  module Unit :
        |    input in0 : Interval(-0.32, 10.1).4
  ...
  "Interval types" should "infer intervals correctly" in {
    val passes = Seq(ToWorkingIR, InferTypesFlowsAndKinds, new InferBinaryPoints(), new TrimIntervals(), new InferWidths())
    val input =
      """circuit Unit :
        |  module Unit :
  ...
  "Interval types" should "be removed correctly" in {
    val passes = Seq(ToWorkingIR, InferTypesFlowsAndKinds, new InferBinaryPoints(), new TrimIntervals(), new InferWidths(), new RemoveIntervals())
    val input =
      """circuit Unit :
        |  module Unit :
        |    input in0 : Interval(0, 10).4
...
"Interval types" should "infer multiplication by zero correctly" in {
  ...
  "Interval types" should "infer dshl correctly" in {
    val passes = Seq(ToWorkingIR, InferTypesFlowsAndKinds, ResolveFlows, new InferBinaryPoints(), new TrimIntervals, new InferWidths())
      val input =
        s"""circuit Unit :
        |  module Unit :
        |    input  p   : UInt<3>
  ...
  "Interval types" should "infer asInterval correctly" in {
    val passes = Seq(ToWorkingIR, InferTypesFlowsAndKinds, new InferWidths())
      val input =
        s"""circuit Unit :
        |  module Unit :
        |    input  p   : UInt<3>
